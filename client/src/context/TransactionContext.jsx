...
export const TransactionProvider = ({children}) => {
    ...
    const handleChange = (e, name) => {
        setFormData((prevState) => ({...prevState, [name]: e.target.value})); //updates the state
    };
    ...
    const connectWallet = async () => {
        try {
            ...
            const accounts = await ethereum.request({ method: "eth_requestAccounts" }); //connect to wallet
